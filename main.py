...
if __name__ == '__main__':
    with psycopg2.connect(database="test_db", user="postgres", password="89268563508") as conn:
        with conn.cursor() as cur:
            create_db(conn, cur)

            # all_clients(cur)

            # add_client(cur, 'Петя', 'Иванов', 'Pivanov@gmail.com', '+79818477777
            # add_client(cur, 'Мария', 'Петрова', 'Petrova1212@gmail.com')
            # add_client(cur, 'Кристиан', 'Иващенко'cris666@gmail.com', '+79263452323')
